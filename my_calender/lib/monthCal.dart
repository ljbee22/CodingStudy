                            ...
                            delegate: SliverChildBuilderDelegate(
                              (BuildContext context, int idx) {
                                return Container(
                                  ...
                                  color: Pastel.green,
                                  child: Text(
                                      "test ${box.get(Provider.of<Cursor>(context, listen: false).returnAsString())![idx].name}"), // hive로 box.get(일자)[idx]
                                );
                              },
                              childCount: box.get(Provider.of<Cursor>(context,
                                              listen: false)
                                          .returnAsString()) ==
                                      null
                                  ? 0
                                  : box
                                      .get(Provider.of<Cursor>(context,
                                              listen: false)
                                          .returnAsString())!
                                      .length,
                            ),
