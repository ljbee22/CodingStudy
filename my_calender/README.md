...
내일 계획
1. 이모티콘 추가 기능 완성 및 이모티콘 저장 box 구현

## 2.6
1. 이모티콘 기능 완성
2. 이모티콘, 할 일 개수, 오늘의 문장 자료형 준비
...
## 2.7
혼자 코딩 - 현태
1. 폰트 변경 기능 추가 -> but 폰트별 크기가 심각하게 다름
2. 오늘의 이모티콘 on, off 기능 추가
3. CustomToggle 일반화

다음 계획
1. 아직 컬러 테마 기능X -> 일종의 colorSet 를 먼저 만들어야 시작 가능할듯 
2. 기능은 다 잘되는데 on-off 가 좀 꼬여서 고쳐야함

## 3.2

1. 하루 감상평 기능 추가 -> but 제대로 저장이 안되는듯
2. 알림 아이콘 오류 수정
3. 메뉴 아이콘들 새롭게 변경
4. 어플 자체 아이콘 새로 적용
...
- 오늘의 이모티콘창 활/비활
- 개발자 괴롭히기(피드백)
3. 알림 아이콘 및 내용 등 수정 필요(현재 빨갛게 나옴)
4. 월간 화면에서 이모티콘 추가할 수 있도록 하기?
